...
# from ai_gateway.prompts.typing import ModelMetadata as V2ModelMetadata
...
async def code_generation(
    ...
    prompt_registry: Factory[BasePromptRegistry] = Provide[
        ContainerApplication.pkg_prompts.prompt_registry.provider
    ],
