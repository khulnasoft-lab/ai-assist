...
CHAT_INVOKABLES = [
    ChatInvokable(name="explain_code", unit_primitive=UnitPrimitive.DUO_CHAT),
    ChatInvokable(name="write_tests", unit_primitive=UnitPrimitive.DUO_CHAT),
    ChatInvokable(name="refactor_code", unit_primitive=UnitPrimitive.DUO_CHAT),
    ChatInvokable(
        name="explain_vulnerability",
        unit_primitive=UnitPrimitive.EXPLAIN_VULNERABILITY,
    ),
    ChatInvokable(
        name="summarize_comments",
        unit_primitive=UnitPrimitive.SUMMARIZE_COMMENTS,
    ),
