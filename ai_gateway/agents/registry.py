...
from ai_gateway.agents.base import BaseAgentRegistry
...
class LocalAgentRegistry(BaseAgentRegistry):
    def __init__(self, agent_definitions: dict[Key, tuple[Type[Runnable], dict]]):
    ...
    @classmethod
    def from_local_yaml(
        cls, data: dict[Key, tuple[str, Type[Runnable]]]
    ) -> "LocalAgentRegistry":
        agent_definitions = {}
